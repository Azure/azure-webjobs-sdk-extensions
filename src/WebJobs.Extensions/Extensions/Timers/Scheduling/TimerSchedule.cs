...
namespace Microsoft.Azure.WebJobs.Extensions.Timers
{
    ...
    public abstract class TimerSchedule
    {
        ...
        internal static TimerSchedule Create(TimerTriggerAttribute attribute, INameResolver nameResolver, TraceWriter trace)
        {
            ...
            if (!string.IsNullOrEmpty(attribute.ScheduleExpression))
            {
                ...
                if (CronSchedule.TryCreate(resolvedExpression, out CronSchedule cronSchedule))
                {
                    ...
                    {
                        trace.Verbose("UseMonitor changed to false based on schedule frequency.");
